...
namespace DC.ETL.Infrastructure.Utils.Tests
{
    
    [TestClass()]
    public class AutoMapperUtilsTests
    {
        static AutoMapperUtilsTests()
        {
            AutoMapperUtils.Register<Name, NameDto>();
        }
        public class Store
        {
        ...
        //}
        [TestMethod()]
        public void CommonMapTest()
        {
            //1.普通转换
            
            Name name1 = new Name() { FirstName = "L", LastName = "jz" };
            NameDto nameDto1 = Mapper.Map<Name, NameDto>(name1);
            string s = "fn:"+ nameDto1.FirstName + " ln:" + nameDto1.LastName;
            Assert.AreEqual("fn:L ln:jz", s);
            nameDto1.AllName = "Z jz E";
            nameDto1.LastName = "ln";
            nameDto1.FirstName = "Z";
            name1 = Mapper.Map<NameDto, Name>(nameDto1);
            s = "fn:" + name1.FirstName + " ln:" + name1.LastName;
            Assert.AreEqual("fn:Z ln:ln", s);
        }
        [TestMethod()]
        public void MapTest()
        {
