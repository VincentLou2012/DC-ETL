...
namespace DC.ETL.Domain.Model
{
    ...
    public class MappingProfile : Profile 
    {
        ...
        public MappingProfile()
        {
            ...
            CreateMap<WholeStructureRcd, WholeStructureRcdDTO>();// 全表数据结构记录 映射
            ...
            CreateMap<WholeStructure, WholeStructureDTO>();// 全表数据结构 映射
            CreateMap<DataSource, DataSourceDTO>();// 数据源 映射
            CreateMap<ExtractStructure, ExtractStructureDTO>();// 抽取数据结构 映射
